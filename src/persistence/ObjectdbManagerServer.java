...
public class ObjectdbManagerServer extends JDialog {
	...
	public ObjectdbManagerServer() {
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
					    ...
					    try {
						    ...
						    try {
						    	Runtime.getRuntime().exec("java -cp lib\\objectdb.jar com.objectdb.Server -port "+ port+" stop");
						    } catch (Exception ioe) {
		...
		try{
		    ...
		    try {
		    	Runtime.getRuntime().exec("java -cp lib\\objectdb.jar com.objectdb.Server -port "+ port+" start");
		    } catch (Exception ioe) {
		    	System.out.println (ioe);
		    }
